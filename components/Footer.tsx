      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-gold-400 mb-4">Emily Buckalew</h3>
            <p className="text-gray-300 mb-4">
              Your trusted real estate professional in Georgia. With years of experience and dedication,
              I'm here to help you find your dream home or sell your property with confidence.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-gold-400 transition-colors">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-gray-400">
          <p>&copy; {currentYear} Emily Buckalew Real Estate. All rights reserved.</p>
        </div>
      </div>
    </footer>
  )
